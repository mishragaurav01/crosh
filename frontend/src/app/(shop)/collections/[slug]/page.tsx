'use client';
import { useCollection, useProductSearch } from '@/hooks/useCatalog';
...
export default function CollectionDetailPage(props: { params: Promise<{ slug: string }> }) {
    ...
    const { data: products, isLoading: prodLoading } = useProductSearch('', '', collection?.id);
    ...
    return (
        <div className="p-8 max-w-6xl mx-auto">
            ...
            <div className="h-64 bg-gradient-to-br from-gray-800 to-gray-900 text-white rounded-xl flex flex-col items-center justify-center mb-8 p-6 text-center">
            ...
            {prodLoading ? (
                ...
                <div className="text-gray-500 text-center py-16 bg-gray-50 rounded-xl">No products found in this collection.</div>
            ) : (
